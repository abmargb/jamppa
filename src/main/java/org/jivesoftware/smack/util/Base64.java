...
public class Base64 {
    ...
    public static String encodeObject(java.io.Serializable serializableObject,
        ...
        try {
            ...
            log.log(Level.ERROR, "Error encoding object", e);
            return null;
        } // end catch
        finally {
            try {
    ...
    public static String encodeBytes(byte[] source, int off, int len,
        ...
        if (gzip == GZIP) {
            ...
            try {
                ...
                log.log(Level.ERROR, "Error encoding bytes", e);
                return null;
            } // end catch
            finally {
                try {
    ...
    public static Object decodeToObject(String encodedObject) {
        ...
        try {
            ...
            log.log(Level.ERROR, "Error reading object", e);
            obj = null;
        } // end catch
        catch (java.lang.ClassNotFoundException e) {
            log.log(Level.ERROR, "Class not found for encoded object", e);
            obj = null;
        } // end catch
        finally {
            try {
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            if (file.length() > Integer.MAX_VALUE) {
                log.warn("File is too big for this convenience method ("
                        + file.length() + " bytes).");
                return null;
            ...
            log.log(Level.ERROR, "Error decoding from file " + filename, e);
        } // end catch: IOException
        finally {
            try {
                bis.close();
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            log.log(Level.ERROR, "Error encoding from file " + filename, e);
        } // end catch: IOException
        finally {
            try {
                bis.close();
    ...
    public static void encodeFileToFile(String infile, String outfile) {
        ...
        try {
            ...
            log.log(Level.ERROR, "Error encoding file " + infile, ex);
        } // end catch
        finally {
            try {
                out.close();
    ...
    public static void decodeFileToFile(String infile, String outfile) {
        ...
        try {
            ...
            log.log(Level.ERROR, "Error decoding file " + infile, ex);
        } // end catch
        finally {
            try {
                out.close();
