...
public class StringUtils {
    ...
    private static Date handleDateWithMissingLeadingZeros(String stampString,
        ...
        List<Calendar> dates = filterDatesBefore(now, oneDigitMonth,
                twoDigitMonth);
    ...
    private static List<Calendar> filterDatesBefore(Calendar now,
            Calendar... dates) {
     ...
     * an XML doc.
     * 
     * <strong>Warning:</strong> This method does not escape unicode character
