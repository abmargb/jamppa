 ...
 * together with a {@link org.jivesoftware.smack.filter.PacketFilter} so that
 * only certain packets are intercepted and processed by the interceptor.
 * <p>
 * 
 * This allows event-style programming -- every time a new packet is found, the
 * {@link #interceptPacket(Packet)} method will be called.
 * 
 * @see Connection#addPacketInterceptor(PacketInterceptor,
