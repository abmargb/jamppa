...
public abstract class Connection {
     ...
     * like {@link UserRoster#createEntry(String, String, String[])},
     * {@link UserRoster#removeEntry(RosterEntry)} , etc. except adding or removing
            ...
            if (debugger == null) {
                ...
                if (className != null) {
                    try {
                        ...
                        log.warn("Unabled to instantiate debugger class " + className);
                    }
                }
