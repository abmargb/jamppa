...
public class LiteDebugger implements SmackDebugger {
	...
	/**
	 * Creates the debug process, which is a GUI window that displays XML
	 * traffic.
	 */
	private void createDebug() {
		...
		// We'll arrange the UI into four tabs. The first tab contains all data,
		// the second
		// client generated XML, the third server generated XML, and the fourth
		// is packet
		...
		menuItem1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				clipboard.setContents(new StringSelection(sentText1.getText()),
						null);
			}
		});
		...
		menuItem1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				clipboard.setContents(
						new StringSelection(receivedText1.getText()), null);
			}
		});
		...
		menuItem1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// Set the sent text as the new content of the clipboard
				clipboard.setContents(
						new StringSelection(interpretedText1.getText()), null);
			}
		});
	...
	public void userHasLogged(String user) {
		...
		String title = "Smack Debug Window -- "
