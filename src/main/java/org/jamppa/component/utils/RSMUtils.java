...
public class RSMUtils {
    ...
    /**
     * Filters response objects based on the RSM parameters. Updates the RSM
     * object with item count, first and last jid
     * 
     * @param objects
     * @param rsm
     * @return
     * @throws IllegalArgumentException
     *             If the item specified by the requesting entity via the UID in
     *             the <after/> or <before/> element does not exist
     */
    public static List<Identifiable> filterRSMResponse(
            List<Identifiable> objects, RSM rsm)
            throws IllegalArgumentException {
        ...
        List<Identifiable> filteredList = outOfRange ? new LinkedList<Identifiable>()
                : objects.subList(initialIndex, lastIndex);
